...
import { Arinc429Builder, type Arinc429Params } from './Arinc429Builder.js';
...
export class TranslationEngine {
   ...
   */
  public processCommand(payload: VistaCommandPayload): void {
  ...
  private translateLightingCommand(payload: VistaCommandPayload): void {
